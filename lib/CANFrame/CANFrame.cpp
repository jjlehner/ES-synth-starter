...
const static int32_t frequencies[] = {int32_t(440.0 * pow(2.0, -9. / 12.)) << 4,
                                    int32_t(440.0 * pow(2.0, -8. / 12.)) << 4,
                                    int32_t(440.0 * pow(2.0, -7. / 12.)) << 4,
                                    int32_t(440.0 * pow(2.0, -6. / 12.)) << 4,
                                    int32_t(440.0 * pow(2.0, -5. / 12.)) << 4,
                                    int32_t(440. * pow(2., -4. / 12.)) << 4,
                                    int32_t(440. * pow(2., -3. / 12.)) << 4,
                                    int32_t(440. * pow(2., -2. / 12.)) << 4,
                                    int32_t(440. * pow(2., -1. / 12.)) << 4,
                                    int32_t(440. * pow(2., 0. / 12.)) << 4,
                                    int32_t(440. * pow(2., 1. / 12.)) << 4,
                                    int32_t(440. * pow(2.0, 2. / 12.)) << 4,
                                    int32_t(0.0)};
